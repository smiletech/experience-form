...
function Addlist() {
  ...
  const Allvalidation = () => {
    if (firstname == "" || lastname == "" || email == "" || address == "" || country == "" || gender == "" || state == "" || pincode == "")
      {
        setvalid(true)
        console.log("first")
        setcount(prev=>prev+1)
  ...
  const Submithandler = () => {
    ...
    console.log(count>=3 &&Allvalidation())

    if (count>=3 &&Allvalidation()) {
      ...
      setvalid(true)
      alert("Minimum 3 skill And ALl field Required")
    }
  };
        ...
        <main>
          ...
          <div className="row g-5">
            <div className="col-md-7 col-lg-8 ms-auto me-auto">
              ...
              <div className={"row g-3 needs-validation was-validated"}>
            ...
            {/* ************* */}
              ...
              <div className="row gy-3 ">
                <div className="col-12">
                  ...
                  {expr.map((ele, index) => {
                    return (
                      <div key={ele.id} className={`card mx-3 mt-3 needs-validation was-validated ind${index}`}>
